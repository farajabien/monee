...
- ✅ **M-Pesa Parser** - Supports 6+ message formats including:
  ...
  - Withdrawals
  - Deposits
- ✅ **Multi-Expense Input** - Paste multiple messages at once
- ✅ **Auto-Categorization** - Smart recipient matching with fuzzy logic
- ✅ **Manual Categorization** - Select default category or override
- ✅ **Expense List** - View, edit, delete expenses
- ✅ **Multi-Day Support** - Handles expenses from different dates
...
- ✅ **Batch Expense Entry** - Paste all daily messages at once
- ✅ **Check-In Status** - Shows completed/pending status
- ✅ **Expense Count** - Displays number of expenses logged
...
- ✅ **Auto-Expense Recording** - Debt payments automatically create expense expenses
...
- ✅ **Multi-Date Preview** - Groups expenses by date in preview
- ✅ **Expense Validation** - Robust error handling for bad formats
...
- [ ] **Gap warnings** - "Missing expenses between Jun 30 - Jul 1"
...
- `/components/expenses/multi-statement-upload.tsx` - New component
...
#### 6. **Expense Search & Filters** 🟢 LOW PRIORITY

- [ ] Search expenses by recipient, amount, date
- [ ] Filter by category, date range
- [ ] Sort options (date, amount, category)

#### 7. **Bulk Expense Actions** 🟢 LOW PRIORITY
...
#### 8. **Recurring Expenses** 🟢 LOW PRIORITY
